...
export default function Navbar() {
    return (
        <nav className='fixed top-6 left-1/2 -translate-x-1/2 w-[90%] maax-w-4xl z-50'>
            <div className='flex items-center justify-between px-6 py-3 bg-white/5 backdrop-blur-lg border border-white/10 rounded-full shadow-2xl'>
                ...
                {/* Call to action */}
                <button className='px-4 py-2 text-xs font-semibold text-black bg-white rounded-full hover-bg-gray-200 transition-colors'>
                    Lets Talk
                </button>
            </div>
        </nav>
